...
<WebElementEntity>
   ...
   <tag></tag>
   <elementGuidId>7774f179-ec0c-4341-848f-13f8f51c7b8e</elementGuidId>
...
.fb_customer_chat_bounce_in{animation-duration:250ms;animation-name:fb_bounce_in}.fb_customer_chat_bounce_out{animation-duration:250ms;animation-name:fb_fade_out}.fb_invisible_flow{display:inherit;height:0;overflow-x:hidden;width:0}.fb_mobile_overlay_active{background-color:#fff;height:100%;overflow:hidden;position:fixed;visibility:hidden;width:100%}@keyframes fb_fade_out{from{opacity:1}to{opacity:0}}@keyframes fb_bounce_in{0%{opacity:0;transform:scale(.8, .8);transform-origin:100% 100%}10%{opacity:.1}20%{opacity:.2}30%{opacity:.3}40%{opacity:.4}50%{opacity:.5}60%{opacity:.6}70%{opacity:.7}80%{opacity:.8;transform:scale(1.03, 1.03)}90{opacity:.9}100%{opacity:1;transform:scale(1, 1)}}#katalon{font-family:monospace;font-size:13px;background-color:rgba(0,0,0,.7);position:fixed;top:0;left:0;right:0;display:block;z-index:999999999;line-height: normal} #katalon div{padding:0;margin:0;color:#fff;} #katalon kbd{display:inline-block;padding:3px 5px;font:13px Consolas,&quot;Liberation Mono&quot;,Menlo,Courier,monospace;line-height:10px;color:#555;vertical-align:middle;background-color:#fcfcfc;border:1px solid #ccc;border-bottom-color:#bbb;border-radius:3px;box-shadow:inset 0 -1px 0 #bbb;font-weight: bold} div#katalon-elementInfoDiv {color: lightblue; padding: 5px}
            ...
            Privacy Policy
                    ...
                    Realia (&quot;Realia&quot;, &quot;we&quot;, &quot;our&quot;, &quot;us&quot;) is an online service that provides users (&quot;you&quot;) with recommendations for Properties, Streets, Suburbs, Rental guides, vacation rentals, and lots more. Our website, mobile properties, and related applications (collectively, our “Website”) are part of Realia® LTD, which is owned and operated by Realia LTD.
                    ...
                    This Privacy Policy was last updated on January 1, 2018. We may change this Privacy Policy from time to time so please check back regularly to keep informed of any updates.
                    Scope
                    ...
                    Personal information includes information you provide us such as your first and last name, telephone number, postal and email addresses, user name and password, and billing information (such as your credit card number, cardholder name, and card expiration date). We may also request information about your rental/buying plans, style, and preferences.
                    You can choose not to provide this personal information to us, but in general some information about you is required in order for you to receive relevant offerings from Realia and its partners and enjoy other benefits of being a registered member. For example, only registered members are able to post reviews, participate in discussion forums, email Realia content to themselves and others, access members-only newsletters and enter surveys, contests, or sweepstakes. In addition, some information is also required in order for you to ask us a question or initiate other transactions on our site.
                    ...
                    You can find out more detailed information about what cookies and similar technologies (such as web beacons) we use in our Cookies Policy [ADD LINK] and our Cookie Consent Tool [ADD LINK].
                    You can also find out more about cookies generally, including how to see what cookies have been set on your device and how to manage and delete them at websites such as www.allaboutcookies.org and www.youronlinechoices.eu
                    Realia, its affiliated websites, and Apps use cookies for the following general purposes:
                    ...
                    Realia is committed to providing you with relevant content and information across our sites.
                    To do this, we may collect information about your housing-related searches and other site activities, such as whether you are looking for a rental or purchasing a property, and use this information to serve you with ads on our sites or elsewhere online that match your interests. So, for example, if you search for a property to purchase in Sydney on Realia, you may see a “for sale “ ad for a Sydney property on Realia or on another website you visit.
                    We only share your personal contact information (such as email addresses) with affiliated third parties so they can serve you with advertisements. You can choose not to receive relevant online advertising on other websites, based on your housing-related searches on Realia by clicking here. Note that if you choose not to receive tailored ads, you will see online advertisements, but they will be more general and less relevant to you. Information on our policy in relation to email contact with you is set out below.
                    Data collected by business partners and ad networks to serve you with relevant advertising
                    Many of the advertisements you see on the Realia family of sites are served by Realia or its service providers. But we also allow third parties to collect information about your online activities through cookies and other technologies. These third parties include (1) business partners, who collect information when you view or interact with one of their advertisements on our sites, and (2) advertising networks, who collect information about your interests when you view or interact with one of the advertisements they place on many different websites on the Internet. The information gathered by these third parties is used to make predictions about your characteristics, interests or preferences and to display advertisements on our sites and across the Internet tailored to your interests.
                    ...
                    Your web browser may transmit a “Do Not Track” (“DNT”) signal to Realia and other websites. Because of differences in web browsers’ default settings and the manner in which browsers incorporate DNT signals, it is sometimes unclear to site operators whether site visitors have selected the DNT setting themselves, or whether they are aware that they have a choice in determining the setting. Realia does not currently respond to DNT signals. Once the Internet industry has settled on standards related to this issue and Realia recognizes such standards, we may re-evaluate this approach. At the present time, our policy in relation to cookies in particular is set out below under “Cookies and Other Web Technologies”.
                    How we use your information
                    General purposes
                    Realia uses the information we collect about you for the following general purposes:
                    
                        for registration and to manage your account, including to allow your access to and use of our site;
                        to communicate with you in general, including to provide information about Realia and invitations from the Realia community;
                        to enable us to publish your reviews, forum posts, and other content to the Realia community;
                        to facilitate your rental application;
                        to respond to your questions and comments;
                        to measure interest in and improve our products, services, and Website;
                        to notify you about special offers and products or services available from us or our partners that may be of interest to you in accordance with your marketing preferences;
                        to otherwise customize your experience with Realia, including customizing the ads shown to you;
                    ...
                    If you have signed up as the owner or manager of a rental property, or listed your rental property, we will send you email messages at the email address you provide to us.
                    Email Communications
                    We want to make it easy for you to take advantage of housing-related opportunities on our Website. One way we do this is by sending you email messages that contain information about your housing-related interests in accordance with your marketing preferences. For example, if your marketing preference is to receive email marketing messages, then if you search for a rental property in Syndey on our website, we may send you an email message rental in Sydney or other Suburbs. We believe these email messages will provide you with useful information about housing-related special offers available through our sites. Please note that you will have the opportunity to choose not to receive these email messages in any such email we send.
                    ...
                    With whom we share your information
                    Realia may share your information with the following entities:
                    
                        Suppliers, including but not limited to agents, insurance companies, banks, local businesses or vacation rental managers or owners who fulfill your housing applications. Throughout Realia and its affiliated sites, all products and services provided by third-party suppliers are described as such. Information that we share with suppliers to facilitate housing will be treated according to applicable suppliers’ privacy policies, except for payment information. We encourage you to review the privacy policies, terms of use, and other policies of any housing supplier whose products and services you may purchase through Realia. Please note that these suppliers also may contact you as necessary to obtain additional information about you or your housing plans, to facilitate your housing application, or for other purposes consistent with the practices described in their privacy policies and terms of use.
                        ...
                        Affiliated Websites. If you were referred to Realia from another website, we may share your registration information, such as your name, email address, mailing address, telephone number and housing preferences, about you with that referring website. We have not placed limitations on the referring websites’ use of personal information and we encourage you to review the privacy policies of any website that referred you to Realia.
                    ...
                    We also may share your information if we believe, in our sole discretion, that such disclosure is necessary...
                        ...
                        to investigate, prevent, or take action regarding illegal or suspected illegal activities; to protect and defend the rights, property, or safety of Realia, our customers, or others; and in connection with our Terms of Use and other agreements; or
                        in connection with a corporate transaction, such as a divestiture, merger, consolidation, or asset sale, or in the unlikely event of bankruptcy.
                    
                    If you choose to create a profile on Realia, certain information in your profile will be publicly viewable and identifiable by clicking your screen name. You will have the ability to view your profile as members of the public will see it. Additionally, if you choose to participate in our member-to-member communications programs (e.g. private messaging), other Realia members may contact you by using Realia as an intermediary; however, Realia will not share your email address with any other members nor display it any public manner. All Realia members have the option to turn off the member-to-member communication features at any time.
                    ...
                    Your rights and choices with respect to the collection and use of your information
                    You can choose not to provide us with your personal information, although it may be needed to take advantage of certain features offered on Realia.
                        ...
                        We endeavour to ensure that your personal information is relevant to its intended use, accurate, and complete. You can also review, add or update the information you have provided to us by visiting your subscriptions page on our Website.
                        You also can add or update information and close your account as described above. If you decide to close your Realia account, we will deactivate your account and remove your profile information from active view.
                        You can close your Realia account by contacting us at contact@realia.com.au. We will send you an email to confirm your request. Please note that after you close an account, you will not be able to sign in or access any of your personal information. However, you can open a new account at any time.
                        When you register as a member of Realia you will have the opportunity to provide us with your marketing preferences, and will be given a choice as to whether you want to receive email marketing messages from Realia. As a registered Realia member, you can modify your choices at any time through the Email Settings of your subscriptions page.
                        Whether registered as a Realia member or not, you also will be given the opportunity to unsubscribe from promotional messages in any such email we send.
                        Please note that we may send you other communications, including service announcements, and administrative messages relating to your Realia account.
                    
                    The Help portion of the toolbar on most browsers will tell you how to prevent your browser from accepting new cookies, how to have the browser notify you when you receive a new cookie, or how to disable cookies altogether. Please note that if you refuse to accept cookies from Realia, you will not be able to access portions of our site.
                    How we protect your information
                    We want you to feel confident about using Realia, and we are committed to protecting the information we collect. While no website can guarantee security, we have implemented and maintain appropriate physical, administrative, technical, and organisational measures to protect the personal information you provide us against unauthorized or unlawful access, use of disclosure, and against accidental loss, damage, alteration or destruction. For example, only authorized employees are permitted to access personal information, and they only may do so for permitted business functions. In addition, we use encryption when transmitting your personal information between your system and ours, and between our system and those of the parties with whom we share sensitive information, and we employ firewalls and intrusion detection systems to help prevent unauthorized persons from gaining access to your information.
                    Children's privacy
                    Realia is a general audience site and does not offer services directed to children. Should an individual whom we know to be a child under age 13 send personal information to us, we will delete or destroy such information as soon as reasonably possible.
                    External links
